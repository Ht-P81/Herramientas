...
public class Musica extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        //si encendida es verdadera (está encendida) utiliza como recurso el icono con el fondo amarillo
        //esto lo utilizamos para que el icono permanezca en amarillo aún cuando salgamos de esa opción, de tal manera que
        //la canción se siga reproduciendo y cuando volvamos a esa opción el icono siga encendido (con el fondo amarillo)
        ...
        botonMusica.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                //hacemos un condicional que diga si está o no encendida la musica mediante un método
                //que todavía no hemos creado que le llamaremos apagaMusica()
                //
    ...
    public void enciendeMusica() {
        ...
        //Ahora le tenemos que decir que comience el servicio y la api dice que la hagamos con un intent.
        ...
        //en este metodo le tenemos que indicar que la variable booleana encendida pasa a estar a true.
        //encendida = true;
