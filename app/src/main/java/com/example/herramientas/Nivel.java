...
public class Nivel extends Fragment implements SensorEventListener {
    ...
    public final void onCreate(Bundle savedInstanceState){
        ...
        //se explica que la variable lado (clase nivelPantalla) puede variar de tamaño según dispositivo
        int lado = getResources().getDimensionPixelSize(R.dimen.maximo);

        //vamos a instanciar nuestra clase nivelPantalla, recibe el contexto (this) en este caso getActivity y el lado
    ...
    public void onResume(){
        ...
        //https://developer.android.com/reference/android/hardware/SensorManager?hl=en#registerListener(android.hardware.SensorEventListener,%20android.hardware.Sensor,%20int)
    ...
    public void onPause(){
        ...
        //debemos desarrollar lo sufiente como para que cuando la aplicación pase a segundo plano deje de registrar, deje de estar a la escucha de esos eventos
        miManager.unregisterListener(this);
    }

    @Override
    public void onSensorChanged(SensorEvent event) {
        //este metodo es el que hay que desarrollar si hay que registrar un cambio en la inclinación del dispositivo
        //cuando se reciba una variación en el sensor que se va a guardar en el objeto event.values, le pasamos ese objeto a nuestro método angulos
